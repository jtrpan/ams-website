...
export default function About() {
  ...
  return (
    <div className="px-10 lg:px-32 py-24 text-center">
      ...
      {/* Subtitle Section */}
      <p className="text-lg lg:text-xl mb-12 text-text-secondary px-4 lg:px-16">{t('subtitle')}</p>
      ...
      <div className="mb-16">
        ...
        <p className="text-lg lg:text-xl text-text-secondary mb-12">{t('choose1')}</p>
